  ...
  public class InventoryCommands : ModuleBase<SocketCommandContext>
  {
    ...
    public async Task ChopWood()
    {
      ...
      else
      {
        ...
        if (inv.AxeUses >= 7 && inv.AxeUses <= 9)
        {
        ...
        if (inv.AxeUses >= 4 && inv.AxeUses <= 6)
        {
        ...
        if (inv.AxeUses >= 2 && inv.AxeUses <= 3)
        {
    ...
    public async Task GambleCommand(int bet = 0)
    {
      ...
      else
      {
        ...
        if (gambleChance >= 13 && gambleChance <= 37)
        {
        ...
        if (gambleChance >= 38 && gambleChance <= 66)
        {
          await MongoHelper.UpdateUser(user.Id, "Gambles", (user.Gambles + 1));
